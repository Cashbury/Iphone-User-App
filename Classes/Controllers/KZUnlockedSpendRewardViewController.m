    //
//  KZUnlockedSpendRewardViewController.m
//  Cashbery
//
...
@implementation KZUnlockedSpendRewardViewController
...
- (id) initWithReward:(KZReward*)theReward {
    self = [super initWithNibName:@"KZUnlockedSpendRewardView" bundle:nil];
    if (self != nil) {
...
- (void)viewDidLoad
{
	...
	if (![self.reward isUnlocked]) {	// not ready
		...
		[self.img_enjoy_crown setImage:[UIImage imageNamed:@"coin_yellow.png"]];
		...
		self.lbl_cost_score.text = [NSString stringWithFormat:@"Ready to enjoy"];
		[self.img_enjoy_text setImage:[UIImage imageNamed:@"tap2enjoy_green.png"]];
		[self.img_enjoy_crown setImage:[UIImage imageNamed:@"coin_green.png"]];
